 ...
 */
public class PasswordBCryptExample {
    // Define the BCrypt workload to use when generating password hashes. 10-31 is a valid value.
    private static int workload = 12;

    public static void main(String[] args) {
        String test_passwd = "1234567890";
//        String test_hash = "$2a$06$.rCVZVOThsIa97pEDOxvGuRRgzG64bvtJ0938xuqzv18d3ZpQhstC";
        String test_hash = "$2a$06$123456789009876543211234567890";
     ...
     * @param stored_hash The account's stored password hash, retrieved from the run database
